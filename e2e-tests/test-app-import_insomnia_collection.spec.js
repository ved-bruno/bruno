...
(async () => {
  ...
  console.log('clicked on the Insomnia Collection');
  const fileChooser = await fileChooserPromise;
  fileChooser.setFiles(path.join(import_location, './Insomnia_2024-12-06.yaml'));
  ...
  execSync(`rm -r ${collection_location}/InsomniaCollection01`);
