...
(async () => {
  ...
  //console.log('clicked on the Postman Collection');
  const fileChooser = await fileChooserPromise;
  fileChooser.setFiles(path.join(import_location, './Test_Colln1.postman_collection.json'));
  ...
  execSync(`rm -r ${collection_location}/Test_Colln1`);
